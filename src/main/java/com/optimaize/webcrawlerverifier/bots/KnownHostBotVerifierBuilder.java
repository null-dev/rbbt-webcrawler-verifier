...
public class KnownHostBotVerifierBuilder {
    ...
    public KnownHostBotVerifierBuilder crawlerData(CrawlerData crawlerData) {
    ...
    /**
     */
    public KnownHostBotVerifierBuilder dnsVerifier(ReverseDnsVerifier dnsVerifier) {
     ...
     */
    public KnownHostBotVerifierBuilder dnsResultCache(Cache<String, BotCheckerResult> dnsResultCache) {
